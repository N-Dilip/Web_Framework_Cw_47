...
public class DilipChildren {
    ...
    public DilipChildren(){}
    public DilipChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
