package com.example.day5_03.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class DilipLanguage {
    @Id
    private int languageId;
    private String languageName;
    private String languageComplexity;
    public DilipLanguage() {
    }
    public DilipLanguage(int languageId, String languageName, String languageComplexity) {
